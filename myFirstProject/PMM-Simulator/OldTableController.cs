...
public class OldTableController
{
    ...
    public RuleTable Populate(int radix, int binSize)
    {
        ...
        EncodingHistogram histogram = EncodingHistogramCreatorWithNormal.Create(binSize, _holder.Step, _holder.X1, _holder.X2, _holder.Center, radix, _holder.Symbols);
